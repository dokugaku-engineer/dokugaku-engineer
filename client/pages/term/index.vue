<template>
  <static-page>
    <section>
        ...
        <ol class="period-num">
          ...
          <li>
            ...
            <ol class="brackets-num">
              ...
              <li>第7条に定める措置を受けたことがある場合</li>
              <li>その他当方が登録を適当でないと判断した場合</li>
            </ol>
          </li>
        </ol>
      </section>
      ...
      <section>
        <h3>第４条（ユーザーIDまたは登録メールアドレス、パスワードの管理）</h3>
        <ol class="period-num">
          <li>
          ...
          <li>ユーザーIDを第三者へ転売、譲渡、貸与することはできません。</li>
          <li>
      ...
      <section>
        ...
        <ol class="period-num">
          <li>
            ...
            <ol class="brackets-num">
              <li>本規約のいずれかの条項に違反する行為</li>
              <li>登録事項に虚偽の情報を申告して登録を行う行為</li>
              <li>6ヶ月以上本サービスの利用を行わない</li>
              <li>
              ...
              <li>第三者に成りすます行為</li>
              <li>本サービスの他の登録ユーザーのアカウントを利用する行為</li>
              <li>
      ...
      <section>
        ...
        <ol class="period-num">
          ...
          <li>当方は、本サービスを予告なしに終了することがあります。</li>
          <li>
